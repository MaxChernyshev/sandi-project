    ...
    <div class="rounded-sm bg-white dark:bg-boxdark">
        <div class="flex justify-end gap-5 xl:gap-20">
            <form action="{{ $route }}" method="{{ $method }}" class="flex space-x-2">
                ...
                <div class="rounded-sm bg-white dark:bg-boxdark">
                    <div class="flex justify-end gap-5 xl:gap-20">
                        <button type="submit" class="inline-flex items-center justify-center rounded-md border border-black px-10 py-4 text-center font-medium text-black hover:font-900 hover:bg-opacity-90 lg:px-4 xl:px-10 dark:bg-white">
                            {{ $buttonName }}
                        </button>
                    </div>
                </div>
