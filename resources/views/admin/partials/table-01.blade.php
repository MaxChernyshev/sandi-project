<div class="rounded-sm border border-stroke bg-white px-5 pb-2.5 pt-6 shadow-default dark:border-strokedark dark:bg-boxdark sm:px-7.5 xl:pb-1">
    ...
    <div class="flex flex-col">
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="flex-shrink-0">
                    <img src="{{ Vite::asset('resources/images/admin/brand/brand-01.svg') }}" alt="Brand"/>
                </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="flex-shrink-0">
                    <img src="{{ Vite::asset('resources/images/admin/brand/brand-02.svg') }}" alt="Brand"/>
                </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="flex-shrink-0">
                    <img src="{{ Vite::asset('resources/images/admin/brand/brand-03.svg') }}" alt="Brand"/>
                </div>
        ...
        <div class="grid grid-cols-3 border-b border-stroke dark:border-strokedark sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="flex-shrink-0">
                    <img src="{{ Vite::asset('resources/images/admin/brand/brand-04.svg') }}" alt="Brand"/>
                </div>
        ...
        <div class="grid grid-cols-3 sm:grid-cols-5">
            <div class="flex items-center gap-3 p-2.5 xl:p-5">
                <div class="flex-shrink-0">
                    <img src="{{ Vite::asset('resources/images/admin/brand/brand-05.svg') }}" alt="Brand"/>
                </div>
