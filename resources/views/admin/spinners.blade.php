...
<html lang="en">
  <head>
    ...
    <title>Spinners | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
  </head>

  <body
    x-data="{ page: 'spinners', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Spinners</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
            ...
            <div class="flex flex-col gap-7.5">
              ...
              >
                ...
                <div class="p-4 sm:p-6 xl:p-9">
                  <div class="flex items-center gap-7.5 xl:gap-17.5">
                    ...
                    <div
                      class="flex size-12.5 items-center justify-center rounded-full border-[7px] border-stroke dark:border-strokedark"
                    >
                      <div class="animate-spin">
                        <svg
                          width="49"
              ...
              >
                ...
                <div class="p-4 sm:p-6 xl:p-9">
                  <div class="flex items-center gap-4">
                    <button
                      class="inline-flex items-center gap-3 rounded-md bg-primary px-5 py-3 text-white"
                    >
                    ...
                    <button
                      class="inline-flex items-center gap-3 rounded-md bg-primary px-5 py-3.5 text-white"
                    >
                      <span class="animate-spin">
                        <svg
                          width="24"
