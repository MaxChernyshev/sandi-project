...
<html lang="en">
  <head>
    ...
    <title>Chat | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
  </head>
                ...
                <div class="hidden h-full flex-col xl:flex xl:w-1/4">
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        class="rounded-md border-[.5px] border-stroke bg-gray-2 px-2 py-0.5 text-base font-medium text-black dark:border-strokedark dark:bg-boxdark-2 dark:text-white 2xl:ml-4"
                        >7</span
                      >
                    </h3>
                  </div>
                ...
                >
                  ...
                  >
                    <div class="max-w-125">
                      ...
                      <div
                        class="mb-2.5 rounded-2xl rounded-tl-none bg-gray px-5 py-3 dark:bg-boxdark-2"
                      >
                        <p class="font-medium">
                    ...
                    <div class="ml-auto max-w-125">
                      <div
                        class="mb-2.5 rounded-2xl rounded-br-none bg-primary px-5 py-3"
                      >
