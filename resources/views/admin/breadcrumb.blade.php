            ...
            >
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li class="font-medium text-primary">Breadcrumb</li>
                    </ol>
                </nav>
            </div>
            <!-- Breadcrumb End -->
            ...
            <div class="flex flex-col gap-7.5">
                ...
                >
                    ...
                    <div class="p-4 sm:p-6 xl:p-10">
                        <div
                            class="rounded-md border border-stroke p-4 py-3 dark:border-strokedark sm:px-6 sm:py-5.5 xl:px-7.5"
                        >
                            <nav>
                        ...
                        >
                            <nav>
                                <ol class="flex flex-wrap items-center gap-3">
                                    <li>
                                        <a
                                            class="flex items-center gap-2 font-medium text-black hover:text-primary dark:text-white dark:hover:text-primary"
                                            href="index.blade.php"
                                        >
                                            <svg
                                                class="fill-current"
