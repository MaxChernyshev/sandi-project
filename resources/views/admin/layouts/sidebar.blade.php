<aside
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{selected: $persist('Dashboard')}">
            ...
            {{--                                       @if(Route::currentRouteName() ==='admin.categories')active @endif--}}
            ...
            {{--                                       @if(Route::currentRouteName() ==='admin.products')active @endif--}}
            {{--                                       :class="page === 'ecommerce' && '!text-white'">--}}
            {{--                                        <i class="nav-icon fas fa-home"></i>--}}
            {{--                                        <p>Products</p>--}}
            {{--                                    </a>--}}
            ...
            <ul class="mb-5.5 mt-4 flex flex-col gap-2.5 pl-6">
                <li class="{{ Route::currentRouteName() ==='admin.main.index' ? 'bg-boxdark' : '' }}">
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                ...
                <li class="{{ Route::currentRouteName() ==='admin.categories.index' ? 'bg-boxdark' : '' }}">
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                       href="{{ route('admin.categories.index') }}">
                        <i class="nav-icon fas fa-home"></i>
                        <p>Categories</p>
                ...
                <li class="{{ Route::currentRouteName() ==='admin.products.index' ? 'bg-boxdark' : '' }}">
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                ...
                <li class="{{ Route::currentRouteName() ==='admin.statements.index' ? 'bg-boxdark' : '' }}">
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                ...
                <li class="{{ Route::currentRouteName() ==='admin.ingridients.index' ? 'bg-boxdark' : '' }}">
                    <a class="group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white"
                       href="{{ route('admin.ingridients.index') }}">
