        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
                ...
                <nav>
                    <ol class="flex items-center gap-2">
                        ...
                        <li class="font-medium text-primary">File Manager</li>
                    </ol>
                </nav>
            </div>
            <!-- Breadcrumb End -->
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
                    ...
                    >
                        <div class="flex items-center gap-5.5">
                            <div
                                class="flex h-15 w-14.5 items-center justify-center rounded-lg bg-[#9B51E0]/[0.08]"
                            >
                                <svg
                                    width="31"
                                    height="31"
                    ...
                    >
                        <div class="flex items-center gap-5.5">
                            <div
                                class="flex h-15 w-14.5 items-center justify-center rounded-lg bg-[#219653]/[0.08]"
                            >
                                <svg
                                    width="31"
                                    height="31"
                    ...
                    >
                        <div class="flex items-center gap-5.5">
                            <div
                                class="flex h-15 w-14.5 items-center justify-center rounded-lg bg-[#2F80ED]/[0.08]"
                            >
                                <svg
                                    width="31"
                                    height="31"
                    ...
                    <div class="flex justify-between px-7.5 py-7">
                        <div class="flex items-center gap-5.5">
                            <div
                                class="flex h-15 w-14.5 items-center justify-center rounded-lg bg-[#F2994A]/[0.08]"
                            >
                                <svg
                                    width="31"
                                    height="31"
            ...
            <div class="mt-7.5 grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
                ...
                <div class="col-span-12 xl:col-span-8">
                    <include src="./partials/chart-10.html"/>
                </div>
                <!-- ===== Chart Ten End ===== -->

                <div class="col-span-12 xl:col-span-4">
                    <div
                        class="flex flex-col gap-4 sm:flex-row md:gap-6 xl:flex-col xl:gap-7.5"
                    >
                        <div
                        ...
                        >
                            <div
                                class="flex flex-col gap-3 2xsm:flex-row 2xsm:items-center 2xl:gap-9"
                            >
                                <div
                                ...
                                >
                                    <svg class="h-33 w-33 -rotate-90 transform">
                                        ...
                                        <circle
                                            class="text-primary"
                                            stroke-width="16"
                                            :stroke-dasharray="58 * 2 * Math.PI"
                                            :stroke-dashoffset="58 * 2 * Math.PI - percent / 100 * 58 * 2 * Math.PI"
                                            stroke-linecap=""
                                            stroke="currentColor"
                                            fill="transparent"
                                            r="58"
                                    ...
                                    <span
                                        class="absolute text-xl font-bold text-black dark:text-white"
                                        x-text="`${percent}%`"
                                    ></span>
                                </div>
                          ...
                          <span class="text-black dark:text-white">150</span
                          ><span class="text-sm"> GB</span> /
                                        <span class="text-black dark:text-white">512</span
                                        ><span class="text-sm"> GB</span>
                                    </p>
                                </div>
                            </div>
                            ...
                            <button
                                class="absolute -right-5 top-1/2 -translate-y-1/2 rotate-[270deg] rounded-t-lg bg-[#13C296] px-4 py-1 font-medium text-white"
                            >
                                Clean
                            </button>
                        </div>
                        ...
                        >
                            <div class="flex gap-4">
                                <div
                                    class="flex h-11.5 w-11.5 items-center justify-center rounded-md bg-[#F6F6F8] dark:bg-graydark"
                                >
                                    <svg
                                        width="24"
                                        height="25"
                          ...
                          >
                                    ...
                                    <div
                                        class="relative h-1.5 w-full rounded-full bg-stroke dark:bg-strokedark"
                                    >
                          <span
                              class="absolute left-0 block h-1.5 w-5/6 rounded-full bg-primary"
                          ></span>
                                    </div>
                                </div>
                            </div>
                          ...
                          >
                                    ...
                                    >
                          <span
                              class="absolute left-0 block h-1.5 w-1/2 rounded-full bg-[#F2994A]"
                          ></span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-span-12">
                    ...
                    >
                        <div
                            class="flex justify-between gap-2.5 px-6 py-3 hover:bg-gray-2 dark:hover:bg-meta-4 sm:items-center sm:justify-start"
                        >
                            ...
                            <div class="text-right sm:w-3/12 xl:w-2/12">
                                <button
                                    class="inline-flex rounded bg-primary px-3 py-1 font-medium text-white hover:bg-opacity-90 sm:px-6 sm:py-2.5"
                                >
                                    Download
                                </button>
                            </div>
