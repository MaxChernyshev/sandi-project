...
<html lang="en">
  <head>
    ...
    <title>
      Mail Success | TailAdmin - Tailwind CSS Admin Dashboard Template
    </title>
  </head>

  <body
    x-data="{ page: 'mailSuccess', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Mail Success</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
