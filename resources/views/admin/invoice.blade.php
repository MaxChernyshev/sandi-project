...
<html lang="en">
  <head>
    ...
    <title>Invoice | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
  </head>

  <body
    x-data="{ page: 'Invoice', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
          ...
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
              ...
              <div class="p-4 sm:p-6 xl:p-9">
                ...
                >
                  <div class="flex flex-col gap-4 sm:flex-row xl:gap-9">
                    <div>
                      ...
                      <h4
                        class="mb-4 text-title-sm2 font-medium leading-[30px] text-black dark:text-white"
                      >
                        Roger Culhane
                      </h4>
                      <a href="#" class="block"
                      ...
                      <span class="mt-2 block"
                        ><span class="font-medium">Address:</span> 2972
                    ...
                    <div>
                      ...
                      >
                      <span class="mt-2 block"
                        ><span class="font-medium">Address:</span> New York, USA
                        2707 Davis Anenue
                      </span>
                    </div>
                  </div>
                ...
                <div
                  class="my-10 rounded-sm border border-stroke p-5 dark:border-strokedark"
                >
                  ...
                  <div class="w-full px-4 xl:w-6/12">
                    <div class="mr-10 text-right md:ml-auto">
                      <div class="ml-auto sm:w-1/2">
                        <p
                          class="mb-4 flex justify-between font-medium text-black dark:text-white"
                        >
                          <span> Subtotal </span>
                          <span> $120.00 </span>
                        </p>
            ...
            >
              ...
              <div class="p-4 sm:p-6 xl:p-9">
                <div
                  class="mb-10 flex flex-wrap items-center justify-end gap-3.5"
                >
                  <button
                ...
                >
                  ...
                  <div
                    class="border-r border-stroke px-5 py-4 last:border-r-0 dark:border-strokedark"
                  >
                    <h5 class="mb-1.5 font-bold text-black dark:text-white">
                      Due Amount :
                    </h5>
