...
@section('content')
    ...
    <main class="u-min-h-screen">
        <div
            class="mx-auto h-[calc(100vh-80px)] max-w-screen-2xl p-4 md:p-6 2xl:p-10"
        >
            <!-- Breadcrumb Start -->
            <div
            ...
            >
                ...
                >
                    <div
                        ...
                        class="fixed bottom-0 top-22.5 z-999 flex w-[230px] -translate-x-[120%] flex-col rounded-md border border-stroke bg-white dark:border-strokedark dark:bg-boxdark lg:static lg:w-1/5 lg:translate-x-0 lg:border-none"
                    >
                        <button
                    ...
                    >
                            ...
                            <span class="opacity-0">
                              <svg width="14" height="14" viewBox="0 0 10 10">
                                ...
                                <div
                                    ...
                                    class="relative flex text-right"
                                >
                                    ...
                                    >
                                        <button
                                            class="w-full rounded px-3 py-2 text-left text-sm hover:bg-gray-2 dark:hover:bg-graydark"
                                        >
                                            Edit
                                        </button>
                                        <button
                        ...
                        <div class="h-full">
                            <table class="h-full w-full table-auto">
                                <thead>
                                <tr
                                    class="flex border-y border-stroke dark:border-strokedark"
                                >
                                  ...
                                  <span class="opacity-0">
                                    ...
                                    <th
                                        class="w-[35%] py-6 pl-4 pr-4 lg:pr-10 xl:w-[20%]"
                                    >
                                ...
                                <tr
                                    class="flex cursor-pointer items-center hover:bg-whiten dark:hover:bg-boxdark-2"
                                >
                                ...
                                >
                                  ...
                                  />
                                    ...
                                    <td
                                        class="w-[35%] py-4 pl-4 pr-4 lg:pr-10 xl:w-[20%]"
                                    >
                        ...
                        >
                            <p
                                class="text-base font-medium text-black dark:text-white md:text-lg"
                            >
                                1-5 of 29
                            </p>
