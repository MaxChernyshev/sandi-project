...
<html lang="en">
  <head>
    ...
    <title>
      Under Maintenance | TailAdmin - Tailwind CSS Admin Dashboard Template
    </title>
  </head>

  <body
    x-data="{ page: 'underMaintenance', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
  ...
  >
    ...
    <section class="bg-white px-4 dark:bg-boxdark-2 sm:px-6">
        ...
        <div class="flex flex-wrap items-center">
          ...
          >
            <div class="px-4 py-20 xl:px-0">
              <div>
                <a href="index.blade.php" class="mb-10 inline-flex">
                  <img
              ...
              >
                ...
                <div>
                  <div class="mb-3 flex items-center gap-2">
                    <template
                      x-for="(minute, index) in minutesArray"
                      :key="index"
                    >
                      <div
                ...
                <div>
                  <div class="mb-3 flex items-center gap-2">
                    <template
                      x-for="(second, index) in secondsArray"
                      :key="index"
                    >
                      <div
