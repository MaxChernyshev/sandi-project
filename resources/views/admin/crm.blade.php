        ...
        <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            >
                ...
                >
                    <div class="flex items-end justify-between">
                        <div>
                            <h3
                                class="mb-4 text-title-lg font-bold text-black dark:text-white"
                            >
                                197
                            </h3>
            ...
            <div class="mt-7.5 grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
                        ...
                        <div class="p-4 md:p-6 xl:p-7.5">
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-2/12 xl:w-3/12">
                                        <div class="flex items-center gap-4">
                                            ...
                                            >
                                                <img src="./images/user/user-17.png" alt="User"/>
                                            </div>
                                    ...
                                    <div class="w-6/12 2xsm:w-5/12 md:w-3/12">
                                        <span class="font-medium">wdavis@aol.com</span>
                                    </div>
                                    <div class="hidden w-4/12 md:block xl:w-3/12">
                                    ...
                                    <div class="w-2/12 xl:w-3/12">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full"
                                            >
                                                <img src="./images/user/user-18.png" alt="User"/>
                                            </div>
                                            <span class="hidden font-medium xl:block"
                                            >Makenna Carder</span
                                            >
                          ...
                          >
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-2/12 xl:w-3/12">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full"
                                            >
                                                <img src="./images/user/user-19.png" alt="User"/>
                                            </div>
                                            <span class="hidden font-medium xl:block"
                                            >Talan Dokidis</span
                                            >
                                    ...
                                    <div class="w-6/12 2xsm:w-5/12 md:w-3/12">
                                        <span class="font-medium">rtaylor@aol.com</span>
                                    </div>
                                    <div class="hidden w-4/12 md:block xl:w-3/12">
                          <span class="font-medium"
                          >25 Dec 2024 - 28 Dec 2024</span
                          ...
                          >
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-2/12 xl:w-3/12">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full"
                                            >
                                                <img src="./images/user/user-20.png" alt="User"/>
                                            </div>
                                            <span class="hidden font-medium xl:block"
                                            >Cheyenne Levin</span
                                            >
                                    ...
                                    <div class="w-6/12 2xsm:w-5/12 md:w-3/12">
                                        <span class="font-medium">ebrown@aol.com</span>
                                    </div>
                                    <div class="hidden w-4/12 md:block xl:w-3/12">
                          <span class="font-medium"
                          >25 Dec 2024 - 28 Dec 2024</span
                          ...
                          >
                                ...
                                <div class="flex items-center gap-3">
                                    <div class="w-2/12 xl:w-3/12">
                                        <div class="flex items-center gap-4">
                                            <div
                                                class="2xsm:h-11 2xsm:w-full 2xsm:max-w-11 2xsm:rounded-full"
                                            >
                                                <img src="./images/user/user-21.png" alt="User"/>
                                            </div>
                                            <span class="hidden font-medium xl:block"
                                            >James Aminoff</span
                                            >
                                    ...
                                    <div class="w-6/12 2xsm:w-5/12 md:w-3/12">
                                        <span class="font-medium">slee@aol.com</span>
                                    </div>
                                    <div class="hidden w-4/12 md:block xl:w-3/12">
                          <span class="font-medium"
                          >25 Dec 2024 - 28 Dec 2024</span
                ...
                <div class="col-span-12 xl:col-span-7">
                    ...
                    >
                        <div
                            class="border-b border-stroke px-4 py-4 dark:border-strokedark md:px-6 md:py-6 xl:px-7.5"
                        >
                            <div class="flex items-start justify-between">
                                <div>
                                    <h2
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex flex-grow items-center gap-4.5">
                                        ...
                                        <div>
                                            <h4
                                                class="mb-2 font-medium text-black dark:text-white"
                                            >
