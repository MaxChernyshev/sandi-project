...
<html lang="en">
  <head>
    ...
    <title>Team | TailAdmin - Tailwind CSS Admin Dashboard Template</title>
  </head>

  <body
    x-data="{ page: 'team', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
            ...
            >
              ...
              <nav>
                <ol class="flex items-center gap-2">
                  ...
                  <li class="font-medium text-primary">Team</li>
                </ol>
              </nav>
            </div>
            <!-- Breadcrumb End -->
              ...
              >
                ...
                <div class="p-4 sm:p-6 xl:p-9">
                  ...
                  >
                    ...
                    <div>
                      <div
                        class="relative z-1 mx-auto h-[170px] w-full max-w-[170px] rounded-full"
                      >
                        <img
                          class="rounded-full"
                      ...
                      <div class="my-5.5 text-center">
                        <h4
                          class="mb-0.5 text-lg font-bold text-black dark:text-white"
                        >
                          Adveen Desuza
                        </h4>
                        <p class="text-xs font-medium">Ui Designer</p>
                      </div>

                      <div class="flex items-center justify-center gap-5.5">
                        <a href="#" class="text-bodydark2 hover:text-primary">
                          <svg
                            class="fill-current"
                            width="20"
                            height="20"
                    ...
                    <div>
                      ...
                      <div class="my-5.5 text-center">
                        ...
                        <p class="text-xs font-medium">Product Designer</p>
                      </div>
                    ...
                    <div>
                      ...
                      <div class="my-5.5 text-center">
                        ...
                        <p class="text-xs font-medium">App Developer</p>
                      </div>
              ...
              >
                ...
                <div class="p-4 sm:p-6 xl:p-9 2xl:p-15">
                  <div class="mx-auto w-full max-w-[1170px]">
                    <div
                      class="grid grid-cols-1 gap-7.5 sm:grid-cols-2 xl:grid-cols-4"
                    >
                      <!-- team item -->
                      <div
                      ...
                      >
                        <div
                          class="relative z-1 mx-auto h-30 w-full max-w-30 rounded-full"
                        >
                          <img
                            class="rounded-full"
                        ...
                        <div class="my-5 text-center">
                          ...
                          <p class="text-xs font-medium">Marketing Expert</p>
                        </div>
                      ...
                      >
                        ...
                        <div class="my-5 text-center">
                          ...
                          <p class="text-xs font-medium">Digital Marketer</p>
                        </div>
                      ...
                      >
                        ...
                        <div class="my-5 text-center">
                          ...
                          <p class="text-xs font-medium">Creative Designer</p>
                        </div>
                      ...
                      >
                        ...
                        <div class="my-5 text-center">
                          ...
                          <p class="text-xs font-medium">SEO Expert</p>
                        </div>
